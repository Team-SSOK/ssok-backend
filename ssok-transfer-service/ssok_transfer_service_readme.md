...
| 패키지 | 클래스 커버리지 | 메서드 커버리지 | 라인 커버리지 |
|--------|----------------|---------------|-----------------|
| `client` | 57% (8/14) | 34% (20/58) | 23% (20/84) |
| `config` | 100% (8/8) | 78% (11/14) | 83% (56/67) |
| `controller` | 100% (2/2) | 22% (2/9) | 11% (2/17) |
| `dto` | 100% (15/15) | 77% (52/67) | 78% (56/71) |
| `entity` | 100% (3/3) | 84% (16/19) | 89% (26/29) |
| `enums` | 100% (4/4) | 91% (11/12) | 93% (28/30) |
| `exception` | 83% (5/6) | 55% (10/18) | 38% (46/121) |
| `grpc` | 100% (1/1) | 28% (2/7) | 4% (2/47) |
| `kafka` | 100% (3/3) | 38% (5/13) | 31% (6/19) |
| `repository` | 100% (1/1) | 100% (2/2) | 100% (33/33) |
| `service` | 100% (6/6) | 100% (30/30) | 91% (237/259) |
| `util` | 100% (1/1) | 100% (2/2) | 66% (4/6) |

테스트 커버리지는 IntelliJ IDEA의 Coverage Runner를 통해 측정되었으며, 실제 비즈니스 로직이 포함된 `service`, `dto`, `entity` 패키지 등은 높은 커버리지를 유지하고 있습니다. 향후 `controller`, `client`, `grpc` 영역에 대한 테스트 커버리지 보강이 예정되어 있습니다.
